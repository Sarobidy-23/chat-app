...
export const ChannelApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    addMember: async (channelId: number, addMemberRequest: AddMemberRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/channels/{channelId}/members`.replace(`{${'channelId'}}`, encodeURIComponent(String(channelId)))
    ...
    getOne: async (channelId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/channel/{channelId}`.replace(`{${'channelId'}}`, encodeURIComponent(String(channelId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
...
export const ChannelApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MemberAdded>> {
    ...
    async createChannel(
      ...
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OneChannelResponse>> {
...
export class ChannelApi extends BaseAPI {
  ...
  public addMember(channelId: number, addMemberRequest: AddMemberRequest, options?: AxiosRequestConfig) {
    return ChannelApiFp(this.configuration)
      .addMember(channelId, addMemberRequest, options)
...
export const MessageApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    getByChannelId: async (channelId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/messages/channel/{channelId}`.replace(`{${'channelId'}}`, encodeURIComponent(String(channelId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
    ...
    getByUserId: async (userId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/messages/{userId}`.replace(`{${'userId'}}`, encodeURIComponent(String(userId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
...
export const MessageApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async createMessage(
      ...
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OneMessageResponse>> {
    ...
    async getByChannelId(
      channelId: number,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AllMessageResponse>> {
...
export class MessageApi extends BaseAPI {
  ...
  public createMessage(createMessage: CreateMessage, options?: AxiosRequestConfig) {
    return MessageApiFp(this.configuration)
      .createMessage(createMessage, options)
      .then(request => request(this.axios, this.basePath))
  }
...
export const UserApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async update(
      ...
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<OneUserResponse>>> {
